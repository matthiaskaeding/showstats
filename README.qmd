...
The `NA%` background becomes darker as the missing share increases. Missing
percentages of 25 percent or more also use bold text.
...
![Great Tables output with grayscale missing percentages](docs/images/gt-output.png)
