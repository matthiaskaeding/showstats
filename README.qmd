...
output returns a Great Tables object that displays as HTML in a notebook. The
missing percentage uses a white to red scale, and values of 20 percent or more
use bold text.
...
![Great Tables output with colored missing percentages](docs/images/gt-output.png)
